        ...
        <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-white via-gray-50/50 to-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              ...
              <GlassCard className="overflow-hidden p-6 sm:p-8 md:p-12 mb-12 bg-white/90">
                {/* Newspaper Header */}
                <div className="border-b-4 border-[#2075bf] pb-4 mb-8">
                  <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#2075bf] uppercase tracking-tight mb-2" style={{ fontFamily: 'var(--font-oswald), sans-serif' }}>
                    About RPM-AVS
                  </h2>
                  <p className="text-sm text-gray-600 uppercase tracking-wider">A Personal, Custom Approach for Every Client</p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
                  ...
                  <div className="lg:col-span-3 space-y-8">
                    {/* Our History */}
                    <article>
                      <h3 className="text-3xl sm:text-4xl font-bold text-[#2075bf] uppercase mb-4 pb-2 border-b-2 border-[#2075bf]/30" style={{ fontFamily: 'var(--font-oswald), sans-serif' }}>
                        Our History
                      </h3>
                  ...
                  <div className="lg:col-span-2">
                    {/* Our Locations */}
                    <article className="mb-8 sticky top-8">
                      <h3 className="text-2xl sm:text-3xl font-bold text-[#2075bf] uppercase mb-4 pb-2 border-b-2 border-[#2075bf]/30" style={{ fontFamily: 'var(--font-oswald), sans-serif' }}>
                        Our Locations
                      </h3>
                      ...
                      <div className="space-y-2 mb-3">
                        {[
                          ...
                          <a
                            ...
                            className="flex items-center gap-3 p-3 rounded-lg bg-gray-50 hover:bg-[#2075bf]/5 hover:border-l-4 border-[#2075bf] transition-all duration-200 cursor-pointer group"
                          >
