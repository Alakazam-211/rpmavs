      ...
      <main className="flex-1">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="glass-card rounded-3xl p-8 md:p-12">
                <div className="mb-8 md:mb-12">
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-[#2075bf] uppercase">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
                  {stats.map((stat, index) => (
                    ...
                    >
                      <div className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#2075bf] mb-2">
                        {stat.number}
                      </div>
                      <div className="text-sm sm:text-base md:text-lg font-semibold text-gray-700 uppercase">
                        {stat.label}
                      </div>
                    </motion.div>
                  ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                ...
                <div className="order-1 md:order-2">
                  <GlassCard className="h-full">
                    ...
                    <h3 className="text-xl sm:text-2xl font-semibold mb-4 text-gray-700 uppercase">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 md:gap-8 items-center">
                  {[
                    ...
                    <motion.a
                      ...
                      className="flex items-center justify-center h-20 p-4 rounded-xl bg-white/50 backdrop-blur-sm border border-gray-200 hover:bg-white/70 hover:scale-105 transition-all duration-300 group"
                    >
                      <img
                        src={brand.useLogo ? brand.logo : brand.favicon}
                        alt={`${brand.name} logo`}
                        className="w-auto h-12 object-contain grayscale group-hover:grayscale-0 transition-all duration-300"
                        onError={(e) => {
        ...
        <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-[#2075bf] via-[#2d8dd4] to-[#1a5d99] relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p className="text-lg sm:text-xl mb-8 text-white/95 max-w-2xl mx-auto leading-relaxed">
